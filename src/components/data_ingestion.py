...
class DataIngestionConfig:
    """Configuration class for data ingestion, setting paths for saving files."""
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        """Reads dataset, splits it into training and testing sets, and saves them."""
        logging.info("Entered the data ingestion method or component")
        try:
            # Read dataset (Ensure the path is correct)
